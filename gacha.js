...
function pullGacha(tokenType) {
    ...
    document.getElementById("result").innerHTML = 
        `${message}<br>A small plastic egg falls into the chute at the bottom of the machine.  You open it and find: <be><br><strong>${selectedItem.name}</strong> (${selectedItem.rarity})<br>
